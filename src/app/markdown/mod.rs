...
#[cfg(test)]
mod test {
    use markdown_fixable_package_table::{
        FixablePackage, FixablePackageTable, FixablePackageVulnerabilities,
    };
    use markdown_policy_evaluated_table::{PolicyEvaluated, PolicyEvaluatedTable};
    use markdown_summary::MarkdownSummary;
    use markdown_summary_table::MarkdownSummaryTable;
    use markdown_vulnerability_evaluated_table::{
